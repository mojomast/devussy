...
function DialogOverlay(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(DialogPrimitive.Overlay, Object.assign({ "data-slot": "dialog-overlay", className: (0, utils_1.cn)("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50", className) }, props)));
}
